...
!(function (J, n) {
  var i,
    ...
    en =
      ...
      (n.DocumentTouch && R instanceof DocumentTouch),
    an = function (n) {
  ...
  J.fn.extend({
    hcOffcanvasNav: function () {
      ...
      var U = this,
        $ = J(R.body);
      void 0 !== n.maxWidth &&
        (e("maxWidth", "disableAt", "option"), (n.disableAt = n.maxWidth));
      var z = J.extend(
          {},
          {
            width: 280,
      ...
      return this.each(function () {
        ...
        if (e.find("ul").addBack("ul").length) {
              ...
              }),
              {
                ...
                add: function (n, e, a) {
                  (n = n.trim()),
                    (e = e.trim()),
                    a
                      ? ((a = a.trim()), (c[a] = c[a] || {}), (c[a][n] = t(e)))
                      : (i[n] = t(e));
                },
                remove: function (n, e) {
                  (n = n.trim()),
                    e
                      ? ((e = e.trim()), void 0 !== c[e][n] && delete c[e][n])
                      : void 0 !== i[n] && delete i[n];
                },
                insert: function () {
                  var n = "";
                  for (var e in c) {
                    for (var a in ((n += "@media screen and (".concat(
                      e,
                      ") {\n"
                    )),
                    c[e]))
                      n += "".concat(a, " { ").concat(c[e][a], " }\n");
                    n += "}\n";
                  }
                  for (var t in i)
                    n += "".concat(t, " { ").concat(i[t], " }\n");
                  o.html(n);
                },
              }),
          ...
          e.addClass("hc-nav-original ".concat(y)),
            z.customToggle
              ? (f = J(z.customToggle)
                  .addClass("hc-nav-trigger ".concat(y))
                  .on("click", _))
              : ((f = J(
                  '<a href="#" aria-label="Open Menu" class="hc-nav-trigger '.concat(
                    y,
                    '"><span></span></a>'
                  )
                ).on("click", _)),
          ...
          var A = function (n, e, a) {
              if ("number" == typeof e && ("number" == typeof n || B.length)) {
                ...
                if (o.length) {
                  ...
                  "number" == typeof n
                    ? o.eq(n).focus()
                    : (B[B.length - 1].focus(), B.pop()),
                    Z.off(d),
                    Z.on(d, function (n) {
                      ("Tab" === n.key || 9 === n.keyCode) &&
                        (n.shiftKey
                          ? R.activeElement === i[0] &&
            ...
            E = function () {
              ...
              v.css("transition", "none"),
                ...
                r.add(
                  ...
                  "transform: translate3d(-".concat(k, "px, 0, 0)")
                ),
                r.add(
                  ".hc-offcanvas-nav.".concat(
                    y,
            ...
            P = function (n) {
              var e = f.css("display"),
                a =
                  !!z.disableAt && "max-width: ".concat(z.disableAt - 1, "px"),
                t = tn(z.width),
                o = tn(z.height);
              -1 !== t.indexOf("px") && (k = parseInt(t)),
                ...
                r.add(
                  ".hc-nav-trigger.".concat(y),
                  "display: ".concat(e && "none" !== e ? e : "block"),
                  a
                ),
                -1 !== ["left", "right"].indexOf(z.position)
                  ? r.add(
                      ".hc-offcanvas-nav.".concat(y, " .nav-container"),
                      "width: ".concat(t)
                    )
                  : r.add(
                      ".hc-offcanvas-nav.".concat(y, " .nav-container"),
                ...
                r.add(
                  ...
                  "transform: translate3d(-".concat(z.levelSpacing, "px,0,0)"),
                  a
                ),
                r.add(
                  ".hc-offcanvas-nav.".concat(
                ...
                r.add(
                  ...
                  "transform: translate3d(0,-".concat(z.levelSpacing, "px,0)"),
                  a
                ),
                r.add(
                  ".hc-offcanvas-nav.".concat(
                ...
                r.insert(),
                (!n || (n && G("pushContent"))) &&
                  ("string" == typeof z.pushContent
                    ? (u = J(z.pushContent)).length || (u = null)
                    : (u =
                        z.pushContent instanceof jQuery
                          ? z.pushContent
                          : null)),
                v.css("transition", "none");
              var i = p.hasClass(V),
              ...
              p
                ...
                .attr("class", "")
                .attr("aria-hidden", !0)
                .attr("aria-labelledby", y)
                .addClass(c),
                z.disableBody && p.on("click", W),
                n ? E() : setTimeout(E, 0);
            },
            M = function () {
              var n;
              h = (function l(n, e) {
                ...
                return (
                  n.each(function () {
                    ...
                    void 0 !== n.attr("data-nav-active") &&
                      ((b = e), n.removeAttr("data-nav-active")),
            ...
            D = function (n) {
              n && (v.empty(), (w = {})),
                (function h(n, e, m, g, a, t) {
                  ...
                  if (
                    (g && o.prepend("<h2>".concat("Bhandara Karo", "</h2>")),
                    J.each(n, function (n, e) {
                      var u = J(
                        '<ul role="menu" aria-level="'.concat(m + 1, '">')
                      )
                        .addClass(e.classes)
                        .appendTo(o);
                            ...
                            var o = a.find("a").addBack("a"),
                              i = o.length
                                ...
                                : J(
                                    ...
                                    .on("click", on);
                            i.is("a") &&
                              i.attr("tabindex", "0").attr("role", "menuitem"),
                              o.length &&
                                i.on("click", function (n) {
                                  n.stopPropagation(),
                                    (J._data(o[0], "events") || {}).click &&
                                      o[0].click();
                                }),
                              "#" === i.attr("href") &&
                                i.on("click", function (n) {
                              ...
                              z.closeOnClick &&
                                (q()
                                  ? i
                                      .filter("a")
                                      .filter(
                                        '[data-nav-close!="false"]:not([disabled])'
                                      )
                                      .filter(function () {
                                        var n = J(this);
                                        return (
                                    ...
                                    ? p(
                                        J(
                                          '<a href="#" class="nav-next" aria-label="'.concat(
                                            d,
                                            ' Submenu" role="menuitem" tabindex="0">'
                                          )
                                        )
                                          .on("click", on)
                                          .insertAfter(i)
                                      )
                                    : (J('<span class="nav-next">').appendTo(i),
                                      p(i));
                    ...
                    var i = o.children("ul"),
                      ...
                      l = J(
                        '<li class="nav-back"><a href="#" role="menuitem" tabindex="0">'.concat(
                          c,
                          "<span></span></a></li>"
                        )
                      ),
                    ...
                    l
                      ...
                      !0 === z.insertBack
                        ? i.first().prepend(l)
                        : an(z.insertBack) && ln(l, z.insertBack, i);
                  }
                  if (0 === m && !1 !== z.insertClose) {
                    var s = o.children("ul"),
                      d = J(
                        '<li class="nav-close"><a href="#" role="menuitem" tabindex="0">'.concat(
                          z.labelClose || "",
                          "<span></span></a></li>"
                        )
                      );
          ...
          var H = function (n, e, a) {
            ...
            if (t.length) {
              ...
              if (
                ...
                i
                  .children(".nav-item-wrapper")
                  .children("[aria-controls]")
                  .attr("aria-expanded", !1),
                -1 !== T.indexOf(o) && T.splice(T.indexOf(o), 1),
                a &&
                  "overlap" === z.levelOpen &&
                  (c.off("click").on("click", on),
                  sn(v, (n - 1) * z.levelSpacing, z.position),
                  u))
              ) {
          ...
          if (
            ...
            ((function () {
              if (
                ...
                z.disableBody &&
                  ((x = X.scrollTop() || Y.scrollTop() || $.scrollTop()),
                  R.documentElement.scrollHeight >
                    R.documentElement.clientHeight &&
                    Y.addClass("hc-nav-yscroll"),
                  $.addClass("hc-nav-open"),
                  x && $.css("top", -x)),
                u)
              ) {
            ...
            if ("number" == typeof n && "number" == typeof e) {
              if (!(a = J("#".concat(y, "-").concat(n, "-").concat(e))).length)
                return void console.warn(
                  "HC Offcanvas Nav: level "
                    .concat(n, " doesn't have index ")
                    .concat(e)
                );
            } else
              b
                ? ((a = v.find(".hc-chk").filter("[value=".concat(b, "]"))),
                  (b = null))
                : !1 === z.closeOpenLevels &&
                  (a = v.find(".hc-chk").filter(":checked").last());
            if (a && a.length) {
              var t = [];
              (n = a.data("level")),
                (e = a.data("index")),
        ...
        function W() {
          if (I()) {
            if (
              ...
              z.disableBody &&
                ($.removeClass("hc-nav-open"),
                Y.removeClass("hc-nav-yscroll"),
                x))
            ) {
              if (
                ($.css("top", "").scrollTop(x),
            ...
            setTimeout(function () {
              p.css("visibility", ""),
                U.trigger("close.$", J.extend({}, z)),
                U.trigger("close.once", J.extend({}, z)).off("close.once");
            }, s);
          }
        }
        function _(n) {
        ...
        function Q(n, e) {
          for (var a = n; a <= Object.keys(w).length; a++)
            ...
            else if (0 !== n || z.closeOpenLevels)
              for (var t = 0; t < w[a]; t++) H(a, t, a == n);
          S && (A(null, n - 1), (S = !1));
        }
      });
    },
