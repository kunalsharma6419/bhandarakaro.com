            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            <h5 class="card-header">Bhandara Location Pincodes</h5>
                            <div class="row">
                                        ...
                                        @foreach ($pincodes as $pincode)
                                            <tr>
                                                ...
                                                <td><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                                    <strong>{{ $pincode->circle_name }}</strong>
                                                </td>
                                                <td><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                                    <strong>{{ $pincode->region_name }}</strong>
                                                </td>
                                                <td><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                                    <strong>{{ $pincode->division_name }}</strong>
                                                </td>
                                                <td><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                                    <strong>{{ $pincode->office_name }}</strong>
                                                </td>
                                                <td><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                                    <strong>{{ $pincode->pincode }}</strong>
                                                </td>
                                                <td><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                                    <strong>{{ $pincode->district }}</strong>
                                                </td>
                                                <td><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                                    <strong>{{ $pincode->state_name }}</strong>
                                                </td>
                                                {{-- <td>
                                                    <div class="dropdown">
                        ...
                        <div class="row">
                            <div class="section-header col-sm-6">
                                <p class="mb-0">Showing {{ $pincodes->firstItem() }} to {{ $pincodes->lastItem() }} of
                                    {{ $pincodes->total() }} entries</p>
                            </div>
                            <div class="col-sm-6">
                                <div class="card-footer text-right">
                                    {{ $pincodes->appends(request()->input())->links('pagination::bootstrap-4') }}
                                </div>
                            </div>
                        </div>
                    </div>
