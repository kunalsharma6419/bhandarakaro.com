                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <h5 class="card-header">Add Bhandara Serving Location </h5>
                                    <div class="card-body">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="state"
                                                        id="basic-default-name" placeholder="Enter State" />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label class="col-sm-2 col-form-label"
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="city"
                                                        id="basic-default-company" placeholder="Enter City" />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label class="col-sm-2 col-form-label"
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="l_pincode"
                                                        id="basic-default-company" placeholder="Enter Pincode" />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
