...
@section('usercontent')
    <div class="w-full min-h-screen LoginOTPBackgroundImage bg-no-repeat bg-cover bg-center flex md:block flex-col">
        <div class="md:hidden">
        ...
        <div class="grow relative sm:static">
            <!-- content -->
            <div class="min-h-full md:w-fits bg-[#F3EFEF] absolute md:w-[29rem] top-[-12%] right-0 w-full md:right-1/2 md:top-[55%] md:translate-x-1/2 md:-translate-y-1/2 lg:right-[10%] lg:translate-x-0 bottom-0 md:min-h-0 md:h-fit rounded-t-[3.6rem] md:rounded-[24px] animate-right-box"
                ...
                <div
                    ...
                    <div class="h-full w-[83%] md:w-[100%] mx-auto">
                        ...
                        <div>
                            <form action="{{ route('user.login.verifyotp.submit') }}" method="post">
                                @csrf
                            ...
                            <div class="">
                                <h5 class="text-sm xs:text-[15px] sm:text-lg lg:text-[22px] text-center">
                                    ...
                                    <a href="{{ route('user.register') }}" class="font-Inter font-medium text-[#dc375d]">
                                        Sign Up.
                                    </a>
                                </h5>
                            </div>
